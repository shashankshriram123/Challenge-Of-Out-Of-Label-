...
pickle_file_path = "/Users/shashankshriram/Downloads/mi3Lab/annotations_public.pkl"  # Replace with your pickle file path
...
#output_file_path = "/Users/shashankshriram/Downloads/mi3Lab/bounding_boxes_output.pkl"  # You can change the output file name and path
...
for box in bounding_boxes[:10]:  # Adjust the range for more boxes
    print(box)